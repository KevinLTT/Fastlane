...
enum ofperr
fastlane_ofputil_decode_flow_mod(struct ofputil_flow_mod *fm,
                        ...
                        struct ofpbuf *remaining_ofpacts)
{
    ...
    error = fastlane_ofpacts_pull_openflow_instructions(&b, b.size,
                                               oh->version, ofpacts, remaining_ofpacts);
    if (error) {
        return error;
    }
